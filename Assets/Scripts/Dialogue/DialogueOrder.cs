...
public class DialogueOrder
{
    ...
    [SerializeField] public MissionObject loadMission;
    ...
    [SerializeField] public MissionObject completeMission;
    ...
    {
        if (this.isLoadMissionIndex)
        {
            if (this.loadMission)
            {
                MissionManager.LoadMission_Object(this.loadMission);
            }
            else
            {
                MissionManager.LoadMission_Index(this.loadMissionIndex);
            }
        }
        if (this.isCompleteMissionIndex)
        {

            if (this.completeMission)
            {
                MissionManager.CompleteMission_Object(this.completeMission);
            }
            else
            {
                MissionManager.CompleteMission_Index(this.completeMissionIndex);
            }
        }
    }
